...
const SORTS: Record<string, (r: CustomerRow & { category?: CustomerCategory }) => number | string | null> = {
  ...
  // «Денег в игре» (21.09): шанс × ожидаемая сумма следующей отгрузки. Это
  // ожидаемая выручка, а НЕ прибавка от звонка — см. комментарий в repeatScore.ts.
  expectedValue: r => r.expectedValue,
  expectedNextAmount: r => r.expectedNextAmount,
};
