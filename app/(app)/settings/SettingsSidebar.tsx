  ...
  const groups: NavGroup[] = [
    ...
    },
    {
      ...
      items: [
        ...
        // Разметка «Нет цены/Есть цена/Спорно» (задача 01.09) — метрики скорости
        // озвучивания цены; влияет на цифры всей компании — только супер-админ.
        { href: '/settings/price-stages', label: 'Цена: разметка стадий', visible: isSuperadmin },
        { href: '/settings/customer-categories', label: 'Категории клиентов', visible: isSuperadmin },
        // Ручные приоритеты кросс-селла (правка владельца 21.09): статистика
        // переходов шумит на сопутствующих товарах («после газобетона — сухие
        // смеси»), здесь её можно перебить вручную для каждой группы.
        { href: '/settings/cross-sell', label: 'Что предложить', visible: isSuperadmin },
        // «Геймификация» (задача 2655, перекомпоновано в табы 2741): каталог бейджей,
        // штрафы, XP, квесты, магазин, гача, выплаты, инвентарь + дашборд экономики
        // первым табом. Роут не менялся (/settings/rewards) — старые ссылки не 404.
        { href: '/settings/rewards', label: 'Геймификация', visible: isSuperadmin },
