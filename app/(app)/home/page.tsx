...
export default async function HomePage() {
  ...
  return (
    ...
    // телефона). На md+ — отступ 15% высоты вьюпорта (правка Иосифа 17.07:
    // «воздух» над приветствием урезан вдвое, было 33%); max()-guard не даёт
    // заголовку прилипнуть к топбару на низких/landscape-экранах. Скролл — на
    // внешнем контейнере, позиция заголовка не прыгает при подгрузке списков ниже.
    <div className="h-full overflow-auto bg-[var(--color-bg)]">
      <div className="flex justify-center px-4 sm:px-8 lg:px-[60px]">
        <div className="w-full max-w-[1060px] flex flex-col items-center pt-14 md:pt-[max(15vh,56px)] pb-10">
