...
export default async function HomePage() {
  ...
  return (
    // pt: верх заголовка — на 33% высоты вьюпорта («золотое сечение», бриф
    // владельца); min(...) через max()-guard не даёт заголовку прилипнуть
    // к топбару на низких/landscape-экранах. Скролл — на внешнем контейнере,
    // сама позиция заголовка не прыгает при подгрузке списков ниже.
    <div className="h-full overflow-auto bg-[var(--color-bg)]">
      <div className="flex justify-center px-4 sm:px-8 lg:px-[60px]">
        <div className="w-full max-w-[1060px] flex flex-col items-center pt-[max(33vh,56px)] pb-10">
