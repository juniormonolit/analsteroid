...
//   СПБ ИТОГО   = Департамент ОС + Департамент НЦ
...
//   МСК ИТОГО   = МСК ОС + МСК НЦ + МСК ЖБИ
//   ОС/НЦ/ЖБИ МСК = одноимённые отделы;  Краснодар = Филиал Краснодар
// Уточнение владельца 02.09 (вечер): «ЖБИ-рег — не учитываем. Как и стажёров и
// ЮЛ» — поэтому СПБ ИТОГО БЕЗ Департамента ЮЛ, МСК ИТОГО БЕЗ «Стажеров МСК»
// (перечислены три отдела явно, а не «Московский филиал» целиком), ЖБИ-рег
// исключён из планов (миграция 197). СПб-стажёры («Отдел стажировки») и так
// вне Департаментов ОС/НЦ.
