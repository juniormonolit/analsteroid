...
export const MANAGER_TABS: { key: ManagerTabKey; label: string }[] = [
  ...
  // Задача 63, п.5: раздел содержит и награды (за них платят MLT), и ачивки
  // (только статус) — ярлык называет обе половины, иначе разделение внутри
  // выглядит как подраздел чего-то одного.
  { key: 'rewards', label: 'Награды и ачивки' },
