...
// линии, 4 кнопки); с v4 (задача 2599) все четыре deals-эндпоинта снова читают
// `filter` ('all'|'sold'), но общая options-форма и дублирующее поле `kind` в
// теле запроса оставлены — обратная совместимость дешевле, сервер лишнее поле
// игнорирует.
