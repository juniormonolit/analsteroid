...
SELECT * FROM (VALUES
  ...
  ('Сертификат Ozon 3 000 ₽',                 'Плейсхолдер — уточняется', 'material', 300::numeric,  '{EBALL,RUB}'::text[], 3, 110),
  ('Сертификат Ozon 10 000 ₽',                'Плейсхолдер — уточняется', 'material', 1000::numeric, '{EBALL,RUB}'::text[], 3, 120),
  ('Топ-приз: техника',                       'Плейсхолдер — флагманский гаджет, уточняется', 'material', 10000::numeric, '{EBALL,RUB}'::text[], 3, 130),
