...
-- (Холодные звонки/Тендеры) НЕ покрыты метриками 1-7 — их stage_id не совпадают
-- со схемой ЧЛ/ЮЛ, канонической группировки для них ещё нет. «Сделок в работе»
-- (8-10) — ПОКРЫВАЕТ все воронки разом (stage_type='WORK', семантическое поле
-- sa.stages, живая проверка 17.07: stage_type ∈ {NEW, WORK, WON, LOSS}).
--
-- СВЕРКА (запрошена явно): «Сделок в работе (все)» НЕ равно сумме 7 метрик выше —
-- ожидаемо, см. финальный отчёт задачи (funnel-покрытие + stage_type='sold' тоже
-- считается WORK, не входит ни в одну из 7).
...
VALUES ('stage_now_new_count', 'Лид (сейчас)', 'Лид', 'external', 'int', NULL, '{}', '{}', false, true, false, false, 0, 'sum', false, false, true, false, 'Стадии (сейчас)', 1300,
